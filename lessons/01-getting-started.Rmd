...
If you have already created the Intro-to-R project but have closed RStudio, you can open it by starting Rstudio, going to Open Project in the File menu, navigating to the Intro-to-R folder and open it. Alternatively, you should be able to find it in the Recent Projects list on the RStudio start page. 
