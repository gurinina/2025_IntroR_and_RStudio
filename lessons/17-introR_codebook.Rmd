...
knitr::opts_chunk$set(echo = TRUE) # this will make sure that the code is displayed in the output
...
```{r}
rpkm_data <- read.csv("data/counts_rpkm.csv") # note the pathname is relative to the working directory if run in console but not if run inline

# rpkm_data <- read.csv("../data/counts_rpkm.csv")
