...
solutions(list(
  quote(metadata[c("sample2", "sample8"), c("genotype", "replicate")])
))
...
solutions(list(
  quote(metadata[c(4, 9), "replicate"])
))
...
solutions(list(
  quote(metadata[, "replicate", drop = FALSE])
))
...
solutions(list(
  quote(metadata[metadata$genotype == "KO", ])
))
