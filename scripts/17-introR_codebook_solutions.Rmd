...
1. **Write a function called `multiply_it`, which takes two inputs: a numeric value `x`, and a numeric value `y`. The function will return the product of these two numeric values, which is `x * y`. To demo your function use `multiply_it(x=4, y=6)` to return an output of `24`.**
...
solutions(
  ...
  ggtitle("Mean expression by age and genotype") +\n
