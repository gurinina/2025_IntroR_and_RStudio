...
The published version for each module can be found at my bookdown sites: [2024_IntroR_and_RStudio](https://bookdown.org/ggiaever/2024_IntroR_and_RStudio/), [RNA-seq-analysis](https://bookdown.org/ggiaever/RNA-seq-analysis/) and
