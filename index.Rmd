...
lof: yes
fontsize: 12pt
github-repo: gurinina/intro-to-R 
...
# Welcome to Applied Omics Science for Drug Discovery and Development! {-}

<p align="center">
  <img src="lessons/img/koos10.png" alt="Welcome to Omics Science!" width="600" />
</p>


The published version for each module can be found at my bookdown sites: [intro-to-R](https://bookdown.org/ggiaever/intro-to-R/), [RNAseq_analysis](https://bookdown.org/ggiaever/RNAseq_analysis/) and
[r4ds-ggplot2](https://bookdown.org/ggiaever/r4ds-ggplot2/).
