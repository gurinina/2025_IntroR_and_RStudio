...
1. Start Rstudio, and go to the `File` menu, select `Open Project`, and navigate to your 2025_IntroR_and_RStudio folder and double click on `2025_IntroR_and_RStudio.Rproj`.
